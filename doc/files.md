...
* .conf: contains configuration settings for d or -qt
* d.pid: stores the process id of d while running
...
* debug.log: contains debug information and general logging generated by d or -qt

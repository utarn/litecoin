...
Below are some notes on how to build  Core for Windows.

The options known to work for building  Core on Windows are:

* On Linux using the [Mingw-w64](https://mingw-w64.org/doku.php) cross compiler tool chain. Ubuntu Bionic 18.04 is required
and is the platform used to build the  Core Windows release binaries.
...
Note that for WSL the  Core source path MUST be somewhere in the default mount file system, for
...
The next three steps are an example of how to acquire the source in an appropriate way.
    ...
    cd /usr/src
    sudo git clone https://github.com/-project/.git
    sudo chmod -R a+rw 

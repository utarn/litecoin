...
"""Verify that starting utharncoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start utharncoin with -h for help text")
        ...
        self.log.info("Start utharncoin with -version for version information")

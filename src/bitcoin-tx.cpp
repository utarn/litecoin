...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s utharncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  utharncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded utharncoin transaction") + "\n" +
              "  utharncoin-tx [options] -create [commands]   " + _("Create hex-encoded utharncoin transaction") + "\n" +
              "\n";

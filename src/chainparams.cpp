...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("66782962d1e9e96c2cd5bd2937acce1462a6a5d175b091fe06b91067535c085b");
        ...
        consensus.nMinerConfirmationWindow = 60; // nPowTargetTimespan / nPowTargetSpacing * 4
        ...
        chainTxData = ChainTxData{
            ...
            1531660480, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        //vSeeds.emplace_back("testnet-seed.utharncointools.com");
        //vSeeds.emplace_back("seed-b.utharncoin.loshan.co.uk");

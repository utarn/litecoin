...
const char* BIP71_MIMETYPE_PAYMENT = "application/-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/-paymentrequest";
